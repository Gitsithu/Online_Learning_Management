...
<section class="content">
 ...
 <?php
                            ...
                            <div class="col-md-12">
                                <div class="input-group input-group-outline mb-3">
                                    <textarea value="{{ isset($course)? $course->description:Request::old('description') }}" name="description" class="form-control date" placeholder="Course Description" id="" cols="30" rows="5"></textarea>
                                ...
                                <div class="col-md-12">
                                <div class="input-group input-group-outline mb-3">
                                    <textarea value="{{ isset($course)? $course->remark:Request::old('remark') }}" name="remark" class="form-control date" placeholder="Course Remark" id="" cols="30" rows="5"></textarea>
