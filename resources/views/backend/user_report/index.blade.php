  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <a href="{{ route('user_export') }}" method="POST" enctype="multipart/form-data"  class="btn btn-success">Excel</a>
          </div>

          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
            <a href='/admin/generate-userpdf' class="btn btn-danger">PDF</a>
            </li>
          </ul>
        </div>
      </div>
          ...
          <div class="card my-4">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              ...
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">User List Report</h6>
                      ...
                      <td class="align-middle text-center text-sm">
                        ...
                        @if($user->Role_ID == 2)
                                              <span class="badge badge-sm bg-gradient-primary">  User </span>
                                               @else
                                               <span class="badge badge-sm bg-gradient-alert"> Admin</span>
                                                @endif
                      </td>
