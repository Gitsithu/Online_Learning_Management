                           ...
                           <div class="container">
                            <div class="row" style="padding-top:5%;">
                                ...
                                <div class="input-group input-group-outline mb-3">
                                            <input type="text" value="{{ old('name') }}" name="name" class="form-control date" placeholder="Bank Name">
                                    </div>
                                </div>

                                <div class="col-md-6">
                                <div class="input-group input-group-outline mb-3">
                                            <input type="text" value="{{ old('user_name') }}" name="user_name" class="form-control date" placeholder="User Name">
                                    </div>
                                </div>
                             ...
                             <div class="row" style="padding-top:2%;">
                                <div class="col-md-6">
                                <div class="input-group input-group-outline mb-3">
                                            <input type="text" value="{{ old('payment_number') }}" name="payment_number" class="form-control date" placeholder="Account Number">
                                    </div>
                                </div>
